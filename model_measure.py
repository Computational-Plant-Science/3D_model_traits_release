...
USAGE:
    ...
    python3 model_measure.py -i ~/example/test.ply  -o ~/example/ --n_slices 200 --slicing_factor 0.3  --visualize 0
...
PARAMETERS:
    ...
    ("--visualize", dest = "visualize", required = False, type = int, default = 0, help = "Display model or not, default not display due to HPC limitaion")
